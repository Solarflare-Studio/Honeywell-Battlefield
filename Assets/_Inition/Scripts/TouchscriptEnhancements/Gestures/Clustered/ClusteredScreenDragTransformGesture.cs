...
namespace TouchScript.Gestures.Clustered
{
    ...
    /// </summary>
    [AddComponentMenu("TouchScript/Gestures/Clustered/Screen Drag Transform Gesture (Clustered)")]
    public class ClusteredScreenDragTransformGesture : ScreenDragTransformGesture
    {
