...
public static class ExtensionMethods
{
    ...
    {
        T[] transforms = target.gameObject.GetComponentsInChildren<T>(true);
	...
	/// <summary>
	/// Get chield from part of a name
	/// </summary>
	/// <returns>The chield from part of a name.</returns>
	/// <param name="target">Target.</param>
	/// <param name="name">Name.</param>
	/// <typeparam name="T">The 1st type parameter.</typeparam>
	public static T GetChildFromNamePart<T>(this Transform target, string name) where T : Component
	{
	...
	/// <param name="name">Name.</param>
	/// <typeparam name="T">The 1st type parameter.</typeparam>
	public static T[] GetChildsFromNamePart<T>(this Transform target, string name) where T : Component
	{
		T[] transforms = target.gameObject.GetComponentsInChildren<T>();
		List<T> arr = new List<T>();
    ...
    public static void ChangeAllChildLayers(this GameObject target, int layer)
    {
